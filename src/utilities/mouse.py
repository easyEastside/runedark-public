...
class Mouse:
    ...
    def move_to(
        ...
        **kwargs,
        ...
        instantiating a `HumanCurve` connecting our current mouse positon and desired
        ...
        For WindMouse style, we obtain the next destiantion xy-coordinate based on the
    ...
    def __get_mouse_speed(self, speed: str = "fast") -> int:
        ...
        Args:
            speed (str): The desired traversel speed in pixels per second. Choose from:
                - "slowest"
                - "slow"
                - "medium"
                - "fast"
