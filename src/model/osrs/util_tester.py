    ...
    def main_loop(self):
        ...
        while time.time() - start_time < end_time:
            msg = (
                ...
                # f"Is there at least one empty slot? {self.inv_has_space()}\n"
                ...
                # f"Char Summary open? {self.is_control_panel_tab_open('character_summary')}\n"
                ...
                # f"Chat-channel open? {self.is_control_panel_tab_open('chat_channel')}\n"
                # f"Frieds list open? {self.is_control_panel_tab_open('friends_list')}\n"
                # f"Account mngmnt open? {self.is_control_panel_tab_open('account_management')}\n"
