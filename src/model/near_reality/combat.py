...
class NRCombat(NRBot):
    def __init__(self):
        title = "Combat"
        description = (
            "This bot attacks NPCs tagged using RuneLite. Position your character in"
            " the viscinity of the tagged NPCs. "
    ...
    def main_loop(self):  # sourcery skip: low-code-quality
        ...
        while time.time() - start_time < end_time:
            # loot
            if not api.is_inv_full() and self.pick_up_loot("Cowhide"):
